  ...
  "data": [
    {
      ...
      "score": 3,
      "interests": [
        { "tag": "Elden Ring", "categoria": "Jogos" }
      ]
    }
  ]
}
...
**Notes**
- Devolve até 30 utilizadores sem ligação com o utilizador autenticado, ordenados por número de interesses em comum (`score`).
...
```json
{
  ...
  "data": {
    ...
    "pending": [
      { "request_id": 14, "usuar_id": 5, "usuar_nome": "Inês Rodrigues" }
    ]
  }
}
```
...
**Notes**
- Devolve apenas eventos confirmados com coordenadas definidas.
...
- **URL:** `/api/api.php?action=admin_get_users`
- **Method:** `GET`
